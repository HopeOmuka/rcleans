...
-- Replies from either side on a support ticket (user or admin)
CREATE TABLE IF NOT EXISTS support_replies (
    id TEXT PRIMARY KEY DEFAULT gen_random_uuid()::text,
    support_message_id TEXT NOT NULL REFERENCES support_messages(id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS idx_support_replies_ticket ON support_replies(support_message_id, created_at ASC);
